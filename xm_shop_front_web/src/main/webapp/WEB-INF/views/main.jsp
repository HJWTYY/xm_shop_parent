            ...
            <div id="xm" class="carousel col-sm-3" data-ride="carousel">
                ...
                <div class="carousel-inner" style="height: 220px">
                    <div class="item active">
                        <img src="${pageContext.request.contextPath}/images/lubotu1.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="${pageContext.request.contextPath}/images/lubotu2.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="${pageContext.request.contextPath}/images/lubotu3.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="${pageContext.request.contextPath}/images/lubotu4.jpg" alt="">
                    </div>
                </div>
                <!--控制器-->
