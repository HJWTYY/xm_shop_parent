...
<div class="navbar navbar-default navbar-fixed-top clear-bottom">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand logo-style" target="_blank" href="http://localhost:8002/">
                <img class="brand-img" src="${pageContext.request.contextPath}/images/config2.gif" alt="logo"
                     height="66">
            </a>
        </div>
